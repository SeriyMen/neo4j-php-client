...
use GraphAware\Neo4j\Client\BoltDriver\Configuration;
...
class StreamSocket extends AbstractIO
{
    ...
    {
        //echo \GraphAware\Neo4j\Client\BoltDriver\Misc\Helper::prettyHex($data) . PHP_EOL;
    ...
    public function read($n)
    {
        ...
        while ($read < $n) {
            ...
            //var_dump(\GraphAware\Neo4j\Client\BoltDriver\Misc\Helper::prettyHex($buffer));
