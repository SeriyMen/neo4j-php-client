...
namespace GraphAware\Neo4j\Client\BoltDriver\Protocol\V1;

use GraphAware\Neo4j\Client\BoltDriver\Driver;
use GraphAware\Neo4j\Client\BoltDriver\Exception\BoltInvalidArgumentException;
use GraphAware\Neo4j\Client\BoltDriver\IO\AbstractIO;
use GraphAware\Neo4j\Client\BoltDriver\Protocol\AbstractSession;
use GraphAware\Neo4j\Client\BoltDriver\Protocol\Message\AbstractMessage;
use GraphAware\Neo4j\Client\BoltDriver\Protocol\Message\AckFailureMessage;
use GraphAware\Neo4j\Client\BoltDriver\Protocol\Message\InitMessage;
use GraphAware\Neo4j\Client\BoltDriver\Protocol\Message\PullAllMessage;
use GraphAware\Neo4j\Client\BoltDriver\Protocol\Message\RawMessage;
use GraphAware\Neo4j\Client\BoltDriver\Protocol\Message\RunMessage;
use GraphAware\Neo4j\Client\BoltDriver\Protocol\Pipeline;
use GraphAware\Neo4j\Client\BoltDriver\Exception\MessageFailureException;
use GraphAware\Neo4j\Client\BoltDriver\Result\Result as CypherResult;
...
class Session extends AbstractSession
{
    ...
    /**
     * @return \GraphAware\Neo4j\Client\BoltDriver\PackStream\Structure\Structure
     */
    ...
    /**
     * @param \GraphAware\Neo4j\Client\BoltDriver\Protocol\Message\AbstractMessage $message
     */
    ...
    /**
     * @param \GraphAware\Neo4j\Client\BoltDriver\Protocol\Message\AbstractMessage[] $messages
     */
