...
namespace GraphAware\Neo4j\Client\BoltDriver\PackStream;

use GraphAware\Neo4j\Client\BoltDriver\Exception\SerializationException;
use GraphAware\Neo4j\Client\BoltDriver\Misc\Helper;
use GraphAware\Neo4j\Client\BoltDriver\PackStream\Structure\Structure;
use GraphAware\Neo4j\Client\BoltDriver\Protocol\Constants;
use GraphAware\Neo4j\Client\BoltDriver\Protocol\Message\RawMessage;
use GraphAware\Neo4j\Client\BoltDriver\Result\Type\Node;
use GraphAware\Neo4j\Client\BoltDriver\Result\Type\Path;
use GraphAware\Neo4j\Client\BoltDriver\Result\Type\Relationship;
...
class Unpacker
{
    ...
    /**
     * @param \GraphAware\Neo4j\Client\BoltDriver\Protocol\Message\RawMessage $message
     *
    ...
    /**
     * @param \GraphAware\Neo4j\Client\BoltDriver\PackStream\BytesWalker $walker
     *
     * @return \GraphAware\Neo4j\Client\BoltDriver\PackStream\Structure\Structure
     */
